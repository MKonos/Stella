...
public class Diagram extends Fragment {
    ...
    PlanetOrbit orbitter;

    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        orbitter = new PlanetOrbit(getActivity());
        orbitter.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        
        orbitter.setBackgroundColor(0xff000000);
    ...
    private static class PlanetOrbit extends View {
        ...
        private static final int numPlanets = 8;               // Number of planets to include (up to 8)
      ...
      orbits it would. */
        ...
        private static final double a[] = {.25, .5, 1.0, 1.5, 2.5, 3.5, 4.5, 5.5};
        ...
        // Constructor
        public PlanetOrbit(Context context) {
